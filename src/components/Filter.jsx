            ...
            <div className="row">
              ...
              <div className="col-sm-12 col-md-6 col-xl-3 text-center mb-3">
                ...
                <DropdownButton
                  ...
                  title="Masukkan Kapasitas Mobil"
                  onSelect={props.handleChangeCategory}
                >
                  <Dropdown.Item eventKey="">Pilih Salah Satu</Dropdown.Item>
              ...
              <div className="col-sm-12 col-md-6 col-xl-3 text-center mb-3">
                ...
                <DropdownButton
                  id="dropdown-basic-button"
                  title="Masukkan Kapasitas Mobil"
                  onSelect={props.handleMaxPrice}
                >
                  <Dropdown.Item eventKey="">Pilih Salah Satu</Dropdown.Item>
                  <Dropdown.Item eventKey="400000">Rp. 400.000</Dropdown.Item>
                  <Dropdown.Item eventKey="600000">
              ...
              <div className="col-sm-12 col-md-6 col-xl-3 text-center mb-3">
                ...
                <DropdownButton
                  id="dropdown-basic-button"
                  title="Masukkan Kapasitas Mobil"
                  onSelect={props.handleStatus}
                >
                  <Dropdown.Item eventKey="">Pilih Salah Satu</Dropdown.Item>
                  <Dropdown.Item eventKey="true">Disewa</Dropdown.Item>
                  <Dropdown.Item eventKey="false">Ready</Dropdown.Item>
                </DropdownButton>
              </div>
