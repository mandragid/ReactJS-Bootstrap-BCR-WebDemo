export const API = {
  ...
  REGISTER_CUSTOMER: "https://bootcamp-rent-cars.herokuapp.com/customer/auth/register",
  LOGIN_CUSTOMER: "https://bootcamp-rent-cars.herokuapp.com/customer/auth/login",
};
